...
ALLOWED_HOSTS = ['photosEuropa-1.onrender.com', '.onrender.com', 'localhost', '127.0.0.1']
...
# ALLOWED_HOSTS = ['photosEuropa.onrender.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'photosEuropa.urls'
